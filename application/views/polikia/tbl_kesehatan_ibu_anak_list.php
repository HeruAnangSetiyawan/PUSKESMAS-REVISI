            ...
            <div class="col-xs-12">
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA KESEHATAN IBU ANAK</h3>
                    </div>
        
        <div class="box-body">
        <div style="padding-bottom: 10px;"'>
        <?php echo anchor(site_url('polikia/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
		<?php echo anchor(site_url('polikia/cetak'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Data', 'class="btn btn-success btn-sm"'); ?></div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "polikia/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_kia",
                            "orderable": false
                        },{"data": "nama_pasien"},{"data": "status_pasien"},{"data": "nama_operasi"},{"data": "biaya"},{"data": "ditangani_oleh"},{"data": "tgl_tindakan"},
                        {
                            "data" : "action",
                            "orderable": false,
