            ...
            <div class="col-xs-12">
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA POLI</h3>
                    </div>
        
        <div class="box-body">
        <div style="padding-bottom: 10px;"'>
        <?php echo anchor(site_url('poli/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
		</div>
                    ...
                    columns: [
                        {
                            "data": "id_poli",
                            "orderable": false
                        },{"data": "nama_poli"},{"data": "ruang_poli"},
                        {
                            "data" : "action",
                            "orderable": false,
