            ...
            <div class="col-xs-12">
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA PERBAIKAN GIZI</h3>
                    </div>
        
        <div class="box-body">
        <div style="padding-bottom: 10px;"'>
        <?php echo anchor(site_url('perbaikangizi/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
        <?php echo anchor(site_url('perbaikangizi/cetak'),'<i class="fa fa-print" aria-hidden="true"></i> Cetak Data', 'class="btn btn-success btn-sm"'); ?>
        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "perbaikangizi/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_gizi",
                            "orderable": false
                        },{"data": "nama_anak"},{"data": "nama_tindakan"},{"data": "nama_obat"},{"data": "jumlah"},{"data": "satuan"},{"data": "tanggal"},
                        {
                            "data" : "action",
                            "orderable": false,
