<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor(site_url('paramedis/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
		<?php echo anchor(site_url('paramedis/cetak'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Data', 'class="btn btn-warning btn-sm"'); ?></div>
