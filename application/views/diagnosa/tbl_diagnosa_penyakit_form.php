...
<table class='table table-bordered>'        
        ...
        <tr><td width='200'>Kode Diagnosa <?php echo form_error('kode_diagnosa') ?></td><td><input type="text" class="form-control" name="kode_diagnosa" id="kode_diagnosa" placeholder="Kode Diagnosa" value="<?php echo $kode_diagnosa; ?>" /></td></tr>
