...
<table class='table table-bordered>'        
	    ...
	    <tr><td width='200'>Kode Supplier <?php echo form_error('kode_supplier') ?></td><td><input type="text" class="form-control" name="kode_supplier" id="kode_supplier" placeholder="Kode Supplier" value="<?php echo $kode_supplier; ?>" /></td></tr>
