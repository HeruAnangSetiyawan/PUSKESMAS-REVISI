<div class="content-wrapper">
    <section class="content">
		...
		<?php echo anchor(site_url('pegawai/cetak'), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Cetak Data Pegawai', 'class="btn btn-danger btn-sm"'); ?></div>
                    ...
                    columns: [
                        {
                            "data": "id_pegawai",
                            "orderable": false
                        },{"data": "id_pegawai"},{"data": "nama_pegawai"},{"data": "jenis_kelamin"},{"data": "npwp"},{"data": "tempat_lahir"},{"data": "tanggal_lahir"},{"data": "nama_jabatan"},{"data": "nama_bidang"},
                        {
                            "data" : "action",
                            "orderable": false,
