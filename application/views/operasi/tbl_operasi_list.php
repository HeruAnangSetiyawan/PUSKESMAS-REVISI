            ...
            <div class="col-xs-12">
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA OPERASI</h3>
                    </div>
        
        <div class="box-body">
        <div style="padding-bottom: 10px;"'>
        <?php echo anchor(site_url('operasi/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "operasi/json", "type": "POST"},
                    columns: [
                        {
                            "data": "kode_operasi",
                            "orderable": false
                        },{"data": "kode_operasi"},{"data": "nama_operasi"},{"data": "biaya"},{"data": "tindakan_oleh"},
                        {
                            "data" : "action",
                            "orderable": false,
