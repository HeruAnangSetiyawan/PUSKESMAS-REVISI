            ...
            <div class="col-xs-12">
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA PENGADAAN OBAT</h3>
                    </div>
        
        <div class="box-body">
        <div style="padding-bottom: 10px;"'>
        <?php echo anchor(site_url('pengadaanobat/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
		<?php echo anchor(site_url('pengadaanobat/cetak'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Data', 'class="btn btn-primary btn-sm"'); ?></div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "pengadaanobat/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_pengadaan",
                            "orderable": false
                        },{"data": "no_trans"},{"data": "supplier"},{"data": "nama_obat"},{"data": "jenis_obat"},{"data": "harga_beli"},{"data": "jumlah"},{"data": "satuan"},{"data": "total"},
                        {
                            "data" : "action",
                            "orderable": false,
