<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor('tindakanberobat/cetakresepobat/'.$no_rawat, 'Cetak Resep Obat', "class='btn btn-success' target='new'"); ?>
...
<div class="modal fade" id="modaltindakan" tabindex="-1" role="dialog" aria-labelledby="modaltindakanLabel">
    ...
    <div class="modal-dialog modal-lg" role="dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('tindakanberobat/resep_action'); ?>
                <table class="table table-bordered ">
